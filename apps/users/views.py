    ...
    def post(self, request, *args, **kwargs):
        ...
        if user:
            ...
            if contact_details[0]["x_studio_estado_del_miembro"] == "Al día":
                ...
                return Response({'error':'Lo sentimos no es posible el acceso con tu estado de miembro actual'}, status=status.HTTP_400_BAD_REQUEST)
            ...
            if contact_ids:
                ...
                if contact_details[0]["x_studio_estado_del_miembro"] == "Al día" and contact_details[0]["x_studio_categora_del_miembro"][1] == "Titular" or contact_details[0]["x_studio_categora_del_miembro"][1] == "Titular Senior" or contact_details[0]["x_studio_categora_del_miembro"][1] == "Honorario" or contact_details[0]["x_studio_categora_del_miembro"][1] == "Correspondiente" or contact_details[0]["x_studio_categora_del_miembro"][1] == "Correspondiente Colombiano" and contact_details[0]["x_studio_clase_de_cliente"][1] == "Miembro" or contact_details[0]["x_studio_clase_de_cliente"][1] == "Registro":
